...
// Type aliases for backward compatibility with lib.rs imports
pub type MetricsRegistry = ProductionMetricsRegistry;
pub type AdapterMetrics = ProductionAdapterMetrics;
